...
Handles cropping and alignment without face-recognition/dlib dependency
"""
import cv2
import numpy as np
...
def _init_mediapipe():
    """Initialize MediaPipe components lazily"""
    global mp_face_detection, mp_face_mesh, FaceDetection, FaceMesh
...
class ImageProcessor:
    ...
    def align_faces(self, img1: Image.Image, img2: Image.Image) -> Tuple[Optional[Image.Image], Optional[Image.Image], bool]:
        """
        Align faces using MediaPipe landmarks
    ...
    def _align_single_image(self, img: Image.Image) -> Optional[Image.Image]:
        """Align image using MediaPipe landmarks"""
        try:
            # Convert to numpy
            img_array = np.array(img)
    ...
    def validate_image(self, img: Image.Image) -> Tuple[bool, str]:
        ...
        try:
            ...
            if width > 5000 or height > 5000:
                return False, "Image too large (max 5000x5000px)"
